...
- simplification in a projected CRS at 750 metres, less than one-third of the
  approximately 2.54-km source cell, followed by exact display-bound clipping;
...
Two cycles are retained after a successful new-cycle promotion. Re-fetching an
unchanged cycle is a semantic no-op: retrieval and candidate-publication times
alone cannot create a data commit. Target filenames include the first 12
